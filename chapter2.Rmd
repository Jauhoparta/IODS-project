...
From these pictures it seems that the model assumptions are approximately correct, with the small exception of small values of Points corresponding to some larger deviation from the estimated mean. Also, a couple of observations seem to have somewhat large leverages, but overall the assumptions of the model seem to hold quite well. 
