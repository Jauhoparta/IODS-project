...
summary(my_model2)
```
From the renewed model we see that the relevant estimate of the coefficient $\beta_{Attitude}$ is approximately 3. This means that Attitude toward the course explains the course grade (specifically, the total points) so that an increase of one in Attitude will lead to an increase of 3 in Points. The intercept parameter is the value of expected points in the exam with an attitude of expected attitude (generally the mean). 
